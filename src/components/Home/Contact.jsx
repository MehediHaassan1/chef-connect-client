...
const Contact = () => {
    return (
        <div className="bg-gray-800 text-gray-100 px-8 py-12 my-12">
            <div className="text-center w-full text-4xl lg:text-6xl">Contact Us</div>
            <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
                <div className="flex flex-col justify-between">
                    ...
                    <div className="mt-8 text-center lg:w-3/5">
                ...
                <div>
                    ...
                    <div className="mt-8">
                        <button className="uppercase text-sm font-bold tracking-wide bg-[#053225] text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                            Send Message
                        </button>
                    </div>
                </div>
